...
------------------------------------------------------------------------------------------------------------------------
--- Begin decker.lua code
--- TODO: Figure out how to import this instead of copying it in here
------------------------------------------------------------------------------------------------------------------------
local Decker = {}
...
local cardFaces = 'http://cloud-3.steamusercontent.com/ugc/1756939300244701875/596150FFA928AC15DF1B27B081D2494EF5FF3801/'
local cardBack = 'http://cloud-3.steamusercontent.com/ugc/1625193014910672699/AEE6A404260E9B5DEE79D2B19CB39F982DCA574D/'

-- define a new asset from face/back links, add width/height (since these default to 1x1)
local cardAsset = Decker.Asset(cardFaces, cardBack)

-- define cards on the asset, skipping three because we can (would be row 2, column 1)
local cardOne = Decker.Card(cardAsset) -- (asset, row, column)
local cardTwo = Decker.Card(cardAsset)
local cardFour = Decker.Card(cardAsset)
...
function onLoad()
   local cardPool = myDeck:spawn({position = {4, 3, 0}, rotation = FACE_DOWN_ROTATION})
   cardPool.setName('CardPool')
end