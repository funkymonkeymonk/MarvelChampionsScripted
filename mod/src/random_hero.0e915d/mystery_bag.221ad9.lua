function updateSave()
    local data_to_save = {["ml"]=memoryList, ["ml2"]=memoryList2, ["ml3"]=memoryList3, ["ml4"]=memoryList4, ["ml5"]=memoryList5, ["ml6"]=memoryList6, ["ml7"]=memoryList7, ["ml8"]=memoryList8}
...
function createSetupActionButtons()
    ...
    self.createButton({
        label="Starter", click_function="buttonClick_starter", function_owner=self,
        position={0,3,-7}, rotation={0,0,0}, height=700, width=2000,
        font_size=700, color={0,0,0}, font_color={1,1,1}
    })
--    self.createButton({
...
function createSetupActionButtons2()
    ...
    self.createButton({
        label="Construct", click_function="buttonClick_construct", function_owner=self,
        position={0,3,-7}, rotation={0,0,0}, height=700, width=2000,
        font_size=700, color={0,0,0}, font_color={1,1,1}
    })
--    self.createButton({
...
--Saves selections
function buttonClick_construct()
...
function createSetupActionButtons3()
    ...
    self.createButton({
        label="Starter", click_function="buttonClick_starter2", function_owner=self,
        position={0,3,-7}, rotation={0,0,0}, height=700, width=2000,
        font_size=700, color={0,0,0}, font_color={1,1,1}
    })
--    self.createButton({
...
function createSetupActionButtons4()
    ...
    self.createButton({
        label="Construct", click_function="buttonClick_construct2", function_owner=self,
        position={0,3,-7}, rotation={0,0,0}, height=700, width=2000,
        font_size=700, color={0,0,0}, font_color={1,1,1}
    })
--    self.createButton({
...
--Saves selections
function buttonClick_construct2()
...
function createSetupActionButtons5()
    ...
    self.createButton({
        label="Starter", click_function="buttonClick_starter3", function_owner=self,
        position={0,3,-7}, rotation={0,0,0}, height=700, width=2000,
        font_size=700, color={0,0,0}, font_color={1,1,1}
    })
--    self.createButton({
...
function createSetupActionButtons6()
    ...
    self.createButton({
        label="Construct", click_function="buttonClick_construct3", function_owner=self,
        position={0,3,-7}, rotation={0,0,0}, height=700, width=2000,
        font_size=700, color={0,0,0}, font_color={1,1,1}
    })
--    self.createButton({
...
--Saves selections
function buttonClick_construct3()
...
function createSetupActionButtons7()
    ...
    self.createButton({
        label="Starter", click_function="buttonClick_starter4", function_owner=self,
        position={0,3,-7}, rotation={0,0,0}, height=700, width=2000,
        font_size=700, color={0,0,0}, font_color={1,1,1}
    })
--    self.createButton({
...
function createSetupActionButtons8()
    ...
    self.createButton({
        label="Construct", click_function="buttonClick_construct4", function_owner=self,
        position={0,3,-7}, rotation={0,0,0}, height=700, width=2000,
        font_size=700, color={0,0,0}, font_color={1,1,1}
    })
--    self.createButton({
...
--Saves selections
function buttonClick_construct4()
...
function createMemoryActionButtons()
    self.createButton({
        label=" S|", click_function="buttonClick_redstarter", function_owner=self,
        position={-4.6,0.5,0}, rotation={0,0,0}, height=1000, width=500,
        font_size=600, color={1,1,1}, font_color={0,0,0}, tooltip="Starter"
    })
    self.createButton({
        label="C", click_function="buttonClick_redconstruct", function_owner=self,
        position={-3.7,0.5,0}, rotation={0,0,0}, height=1000, width=500,
...
function buttonClick_redstarter(obj, player_color)
    if player_color ~= "Red" then
        buttonClick_bluestarter(obj, player_color)
    else
...
function buttonClick_bluestarter(obj, player_color)
    if player_color ~= "Blue" then
        buttonClick_greenstarter(obj, player_color)
    else
        local bagObjList = self.getObjects()
...
function buttonClick_greenstarter(obj, player_color)
    if player_color ~= "Green" then
        buttonClick_yellowstarter(obj, player_color)
    else
        local bagObjList = self.getObjects()
...
function buttonClick_yellowstarter(obj, player_color)
    if player_color ~= "Yellow" then
        broadcastToAll("Please take a valid seat", {1,1,1})
    else
        local bagObjList = self.getObjects()
...
function buttonClick_redconstruct(obj, player_color)
    if player_color ~= "Red" then
        buttonClick_blueconstruct(obj, player_color)
    else
        local bagObjList = self.getObjects()
...
function buttonClick_blueconstruct(obj, player_color)
    if player_color ~= "Blue" then
        buttonClick_greenconstruct(obj, player_color)
    else
        local bagObjList = self.getObjects()
...
function buttonClick_greenconstruct(obj, player_color)
    if player_color ~= "Green" then
        buttonClick_yellowconstruct(obj, player_color)
    else
        local bagObjList = self.getObjects()
...
function buttonClick_yellowconstruct(obj, player_color)
    if player_color ~= "Yellow" then
        broadcastToAll("Please take a valid seat", {1,1,1})
    else
        local bagObjList = self.getObjects()
