...
function addTough()
toughBag = getObjectFromGUID('35b809')
toughToken = toughBag.takeObject()
toughToken.setPosition{1.75, 1.5, 21.25}
toughToken.setRotation{0,180,0}
toughToken.setScale{0.61, 1.00, 0.61}
end
