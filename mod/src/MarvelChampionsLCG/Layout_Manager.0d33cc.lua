...
--Moving zone management here, so that it is available to both scenarios and heroes. Once layout functionality is deprecated, the layout manager can become the zone manager.
