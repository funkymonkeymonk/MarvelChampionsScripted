function getHeroDetails()
    ...
    heroDetails.identityGuid = "11106b"
    heroDetails.starterDeckId = 344801
    heroDetails.heroDeckId = 347708
    heroDetails.nemesisGuid = "6e4469"
    heroDetails.obligationGuid = "55c0e6"
